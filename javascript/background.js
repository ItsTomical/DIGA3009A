(function() {
  ...
  function makeSticker(src) {
    ...
    const min = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--sticker-min")) || 56;
    const max = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--sticker-max")) || 120;
    ...
    el.style.animation = `${reverse ? "floatYReverse" : "floatY"} ${duration}s ease-in-out ${delay}s infinite`;
